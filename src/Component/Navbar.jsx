      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <p className="logo_name">webure Technologies</p>
          </div>
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
              href="/"
              className="letstalk_button ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2  shadow-sm text-base font-medium "
            >
              Let's Talk
            </a>
          </div>
              ...
              <nav className="grid gap-y-8">
                {navLinks.map((text) => (
                  <a
                    key={text.id}
                    href="/"
                    className="-m-3 p-3 capitalize flex items-center rounded-md hover:bg-gray-50"
                  >
                    <svg
